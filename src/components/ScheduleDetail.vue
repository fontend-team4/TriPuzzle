<template>
  <div class="min-w-full h-screen flex flex-row-reverse bg-gray z-10">
    <div class="w-full lg:w-96 h-screen bg-white shadow-xl">
      <!-- header -->
      <div class="bg-primary-600 z-10 py-5 ps-4 pe-14 relative">
        ...
        <button class="bg-gray opacity-80 text-gray-600 w-8 h-8 rounded-full absolute top-3.5 right-4 p-1.5 hover:opacity-90 tooltip tooltip-bottom" data-tip="隱藏行程">
          <XMarkIcon />
        </button>
      </div>
      <!-- date tab -->
      ...
      <div class="">
        ...
        <div class="min-h-[500px] pt-5 px-5 pb-10 overflow-y-scroll overflow-x-hidden bg-white">
          <!-- no place -->
          <div class="w-full bg-gray rounded-xl py-10 px-5 mb-5 hidden">
