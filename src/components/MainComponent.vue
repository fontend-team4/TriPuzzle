...
const transportationSwitch = computed(() => {
  return transportationOpen.value
...
<template>
  ...
  <div class="relative h-screen overflow-hidden">
    <MapComponent />
    <PlacesComponent
      class="absolute top-0 z-10 transition-all"
  ...
  <div
    class="min-w-full h-screen flex flex-row-reverse bg-gray overflow-x-hidden"
  >
    <div
      class="schedule-list w-full lg:w-96 h-screen bg-white shadow-xl transition-all"
      :class="listSwitch"
    >
      <!-- 行程 toggle -->
      <div
        class="schedule flex items-center text-white w-[56px] hover:w-[86px] h-10 py-2 ps-3 pe-5 bg-yellow-500 rounded-s-full shadow-lg absolute top-4 left-[-56px] hover:left-[-86px] hover:cursor-pointer"
        @click="listToggle"
      ...
      <div class="p-5 relative">
        ...
        <div class="pb-3 relative bg-white z-10">
          ...
          <div class="dropdown">
            ...
            <ul
              tabindex="0"
              class="dropdown-content menu bg-white rounded-sm z-[1] w-44 p-0 border absolute top-8 left-0"
            >
        ...
        <div class="h-[70vh] overflow-y-scroll pb-12">
          ...
          >
            <div
              class="card card-compact bg-base-100 sm:w-full md:w-[30%] lg:w-full h-[176px] lg:h-auto border mb-4 relative hover:cursor-pointer"
            >
              ...
              <div class="flex gap-2 absolute top-3 right-3">
                ...
                <div class="dropdown">
                  ...
                  <ul
                    tabindex="0"
                    class="dropdown-content w-32 bg-white rounded border absolute right-0 top-10"
                  >
                    <li>
                      <a
        ...
        <!--已登入 -->
        <div
          class="w-full lg:w-96 h-20 px-2.5 py-5 bg-white border-t fixed bottom-0 right-0"
        >
          <button
