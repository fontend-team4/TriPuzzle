...
const tabs = [
  ...
  },
  {
    label: '創建行程',
    title: '預訂航班和住宿加入行程',
    text: '先為你的行程取個有趣的名字，再來預訂好航班機票和飯店，就可以開始你的每日行程安排了！世界各國旅遊都能用旅圖規劃！',
    image: 'mockup-2'
  },
  {
    label: '好友共編',
    title: '與好友共編行程',
    text: '分享行程給旅伴一起編輯，討論行程路線更快速方便。「下一站要去哪？」打開旅圖立馬就知道！',
    image: 'mockup-3'
  },
  {
    label: '搜尋景點',
    title: '全球景點你都能找到',
    text: '國內外景點、餐廳美食、飯店民宿、購物商場...用旅圖你能找到最多人去的/評分最高的/最多人收藏的，還有更多寶藏景點。想去就直接加入行程表！',
    image: 'mockup-4'
  },
  {
    label: '加入行程',
    title: '一鍵排序生成路線',
    text: '你只要狂加景點，讓旅圖自動幫你生成路線！參考「全行程最順路」提示加入行程，景點路線走法一清二楚，還能再自己編輯調整！',
    image: 'mockup-5'
  },
  {
    label: '行前準備',
    title: '一站搞定所有最簡單輕鬆',
    text: '景點門票、超多日本優惠券、租車、叫車、旅平險，用旅圖都能一指搞定。All in one 的強大旅圖，罩著你的玩！',
    image: 'mockup-6'
  },
  {
    label: '製作小書',
