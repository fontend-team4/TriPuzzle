...
const getSchedules = async () => {
  ...
  try {
    const response = await axios.get(`${API_URL}/schedules/${scheduleId}`, config);
...
const getGroupData = async () => {
  ...
  try {
    const { data } = await axios.get(`${API_URL}/usersSchedules/${scheduleId}/users`, config);
...
const getAccount = async () => {
  ...
  try {
    ...
    const response = await axios.get(`${API_URL}/groups/${scheduleId}/bills`, config);
